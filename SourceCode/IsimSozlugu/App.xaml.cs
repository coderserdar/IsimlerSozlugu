    ...
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            using (var context = new NameDataContext(NameDataContext.ConnectionString))
            {
                ...
                {
                    using (var context2 = new NameDataContext(NameDataContext.ConnectionString))
                    {
        ...
        private static void DilAyariOlustur(NameDataContext context)
        {
            ...
            CultureInfo newCulture = new CultureInfo("tr");
            Thread.CurrentThread.CurrentCulture = newCulture;
            Thread.CurrentThread.CurrentUICulture = newCulture;
        }
    }
